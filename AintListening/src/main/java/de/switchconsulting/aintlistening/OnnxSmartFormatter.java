 ...
 * using an ONNX model.
 */
public class OnnxSmartFormatter implements SmartFormatter {
    private static final String TAG = "OnnxSmartFormatter";
    ...
    /**
     * Constructs a new OnnxSmartFormatter and initializes the ONNX environment and model.
     *
     ...
     */
    public OnnxSmartFormatter(@NonNull Context context, @NonNull ModelInfo info) throws Exception {
